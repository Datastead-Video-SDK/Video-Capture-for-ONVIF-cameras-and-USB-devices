...
// MFCFormDlg.cpp : implementation file
//

#include "pch.h"
#include "framework.h"
#include "MFCForm.h"
#include "MFCFormDlg.h"
...
void CMFCFormDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
}

BEGIN_MESSAGE_MAP(CMFCFormDlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_SIZE()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDOK, &CMFCFormDlg::OnBnClickedOk)
END_MESSAGE_MAP()


// CMFCFormDlg message handlers
...
void CMFCFormDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
HCURSOR CMFCFormDlg::OnQueryDragIcon()
{
